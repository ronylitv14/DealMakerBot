...
<i>Ви обрали суму:</i> <b>{dialog_data[input_money_adding]}</b> грн\n
...
greetings_text = """
🚀 <b>Ваше спілкування може розпочатися зараз!</b> 🚀

Ось кілька простих кроків, щоб все пройшло гладко:

1️⃣ <b>Узгодження ціни</b>: Перш за все, домовтеся про ціну виконання замовлення. Це важливий етап, на якому ви повинні досягти згоди.

2️⃣ <b>Команда оплати</b>: Як тільки умови замовлення та кінцева ціна узгоджені, виконавець повинен використати команду /pay для встановлення ціни.

3️⃣ <b>Підтвердження ціни клієнтом</b>: Після цього клієнт має можливість підтвердити ціну в своєму діалозі або відмовитися, якщо ціна не відповідає попередньо обговореній.

4️⃣ <b>Важливе підтвердження</b>: У випадку підтвердження ціни клієнтом, з'являється вікно з підтвердженням виконання. 

🛑<b>Увага</b>: не поспішайте підтверджувати виконання замовлення одразу! Робіть це лише після того, як отримаєте всі виконані завдання. (За детальною інформацією звертайтесь до вікна підтвердження виконання).

<i>Це допоможе забезпечити чіткий та ефективний процес спілкування між вами. Успіхів!</i>
"""

accept_execution_text = "Дане повідомлення призначення для того, щоб підтвердити успішне виконання завдання виконавцем. "
